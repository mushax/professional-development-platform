...
<button
    ...
    @click="toggle()"
    class="flex items-center justify-center w-10 h-10 text-gray-500 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none {{ $class }}"
>
