            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h3 class="text-lg font-medium">{{ __('general.welcome_back') }}, {{ Auth::user()->name }}!</h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('general.dashboard_intro') }}
                        </p>
                    </div>
                </div>
                    ...
                    <a href="{{ route('cv-builder.index') }}" class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ __('general.cv_builder_title') }}</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('general.cv_builder_description') }}</p>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="bg-white dark:bg-gray-800/50 overflow-hidden shadow-sm sm:rounded-lg cursor-not-allowed opacity-60">
                         <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ __('general.opportunity_hub_title') }}</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('general.coming_soon') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <a href="{{ route('profile.edit') }}" class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
                         <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ __('general.my_profile_title') }}</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ __('general.my_profile_description') }}</p>
                                </div>
                            </div>
                        </div>
                    </a>
